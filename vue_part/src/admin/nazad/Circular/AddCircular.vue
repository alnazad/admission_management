    ...
    <div class="container" >
        ...
        <div class="row" style="border: 1px solid green;color: blue;">
            ...
            <div class="col-6" style="margin-top:10px">
                ...
                <label style="text-align: right;" class="col-5">Circular Name<span style="color: red;">*</span></label>
                <input  type="text" style="text-align: left; " class=" col-7 " v-model="circular_name">
                <label style="text-align: right;" class="col-5">Circular Description<span style="color: red;">*</span></label>
